    ...
    public partial class TankControl : UserControl
    {
        ...
        public Color BaseColor
        {
            ...
            { 
                ...
                Color foreColor = this.ContrastColor(value);

                tankLinearGauge1.ForeColor = foreColor;
                tankLinearGauge2.ForeColor = foreColor;
                tankGauge1.ForeColor = foreColor;
                labelVolume.ForeColor = foreColor;
                label1.ForeColor = foreColor;
                label2.ForeColor = foreColor;
                label6.ForeColor = foreColor;
                labelVolumeNormalized.ForeColor = foreColor;
                labelAveragePrice.ForeColor = foreColor;
            }
        ...
        public void RefreshValues()
        {
            ...
            this.label3.Text = string.Format("Διαθέσιμος Όγκος : {0} Lt", decimal.Round((decimal)0.95 * this.Tank.TotalVolume - this.Tank.CurrentVolume, 0));
            ...
            this.labelSerial.Text = this.tank.SerialNumber;
            ...
            if (tank.TankStatus == Common.Enumerators.TankStatusEnum.Offline)
            {
                ...
                this.tankGauge1.StateColor = Color.Green;
            else if (tank.TankStatus == Common.Enumerators.TankStatusEnum.Error || tank.TankStatus == Common.Enumerators.TankStatusEnum.LowLevel || tank.TankStatus == Common.Enumerators.TankStatusEnum.HighLevel || 
        ...
        private void tankGauge1_DoubleClick(object sender, EventArgs e)
        {
            if(this.label6.Visible)
            {
                this.label6.Hide();
                this.labelAveragePrice.Hide();
            }
            else
            {
                this.labelAveragePrice.Show();
                this.label6.Show();
            }
        }
    }
