...
namespace ASFuelControl.Windows.UI.Controls
{
    public partial class TankLinearGauge : UserControl
    {
        ...
        private void DrawTankGaugeVertical(Color baseColor, Graphics gr)
        {
            ...
            Brush bt = new SolidBrush(this.ForeColor);
            gr.DrawString(this.CurrentLevel.ToString("N0"), new Font(this.Font.FontFamily, fontSize), bt, new Rectangle(pText, new Size(this.Width, (int)(h * 0.15f))));
            bt.Dispose();
            brush.Dispose();
            brush2.Dispose();
            shadowBrush.Dispose();
