...
namespace ASFuelControl.Windows.UI.Forms
{
    public partial class DispenserTransactionsForm : RadForm
    {
        ...
        public DispenserTransactionsForm()
        {
            ...
            this.Disposed += DispenserTransactionsForm_Disposed;
        }

        private void DispenserTransactionsForm_Disposed(object sender, EventArgs e)
        {
        ...
        private void salesTransactionRadGridView_CommandCellClick(object sender, EventArgs e)
        {
            ...
            {
                Telerik.WinControls.RadMessageBox.Show("Παρακαλώ εκτυπώστε το παραστατικό χρησιμοποιόντας τον φορολογικά σας μηχανισμό", "Σφάλμα Επανεκτύπωσης", MessageBoxButtons.OK, Telerik.WinControls.RadMessageIcon.Info);
                return;
            }
        ...
        private void radButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                cif.DispenserId = this.DispenserId;
                cif.ShowDialog(this);
            }
            this.database = new Data.DatabaseModel(Properties.Settings.Default.DBConnection);
            this.LoadData();
            //this.database.Refresh(Telerik.OpenAccess.RefreshMode.OverwriteChangesFromStore, this.database.InvoiceLines);
            //this.database.Refresh(Telerik.OpenAccess.RefreshMode.OverwriteChangesFromStore, this.database.Invoices);
        }
    }
