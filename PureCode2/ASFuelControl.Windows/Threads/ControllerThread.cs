        ...
        private void ThreadStart()
        {
            try
            {
                ...
                foreach(ASFuelControl.FuelPump.FuelPumpWorkFlow workFlow in this.fpWorkFlows)
                {
                    ...
                    {
                        workFlow.Controller.AddFuelPoint(workFlow.Dispenser.ChannelId, workFlow.Dispenser.AddressId, workFlow.Dispenser.Nozzles.Length, workFlow.Dispenser.DecimalPlaces, workFlow.Dispenser.VolumeDecimalPlaces, workFlow.Dispenser.UnitPriceDecimalPlaces);
