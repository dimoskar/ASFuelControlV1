...
namespace ASFuelControl.Communication
{
    public class SendMethods
    {
        ...
        public SendMethods()
        {
            //try
            //{
            //    System.Reflection.Assembly assembly = System.Reflection.Assembly.LoadFrom("EToken\\eTokenLib.dll");
            //    //Type type = assembly.GetType("eTokenLib.eTokenLib");

            //    eTokenLib.eTokenLib etoken = (eTokenLib.eTokenLib)assembly.CreateInstance("eTokenLib.eTokenLib");
            //}
            //catch (Exception ex)
            //{
            //}
        ...
        public string SendAlert(ClientHeader header, AlertClass alertClass)
        {
            ...
            alert.F_ALERT.F_REASONING = alertClass.Description;
