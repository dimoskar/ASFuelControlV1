namespace ASFuelControl.Reports
{
    partial class NozzleTotalsReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox10.Value = "=Sum(Fields.TotalCounter/ Pow(10, Fields.Dispenser.TotalVolumeDecimalPlaces))";
            // 
            // shape2
            // 
    ...
    "PublicKeyToken=null";
            ...
            this.textBox7.Value = "=Sum(Fields.TotalCounter/ Pow(10, Fields.Dispenser.TotalVolumeDecimalPlaces))";
            // 
            // textBox8
            // 
            ...
            this.totalCounterDataTextBox.Format = "{0:N2}";
            ...
            this.totalCounterDataTextBox.Value = "=Fields.TotalCounter / Pow(10, Fields.Dispenser.TotalVolumeDecimalPlaces)";
            // 
            // NozzleTotalsReport
            // 
