...
namespace MillenniumAPI
{
    public class DispenserCommands
    {
        ...
        public byte[] CreateCmd(int dispenserId, int fuelPointChannel, CmdEnum command, int price)
        {
            ...
            {   //FD 01 00 02 01 00 02 00 0C 04 [21] 21 [01 00] 01 05 06 07 08 0C 15 FC 30 30 39 35 FB 
                ...
                int p1 = Convert.ToInt32((sprice.Substring(0, 2)));
                int p2 = Convert.ToInt32((sprice.Substring(2, 2)));
                buffer = new byte[] { 0xFD, (byte)(dispenserId), 0x00, 0x02, 0x01, 0x00, 0x02, 0x00, 0x0C, 0x04, (byte)(fuelPointChannel), 0x21, (byte)ith(p1), (byte)ith(p2), 0x01, 0x05, 0x06, 0x07, 0x08, 0x0C, 0x15, 0xFC };
                return returnCmdWithCrc(buffer);
            }
            else
            {
        ...
        public List<MilleniumNozzle> EvaluateBuffer(byte[] buffer)
        {
            string price = "";
            string litres = "";
            string totalLitres = "";
            ...
            {   //todo 
                ...
                switch (response.Length)
                {
                    ...
                    case ((int)ResponseLengthEnum.SendPriceConfirm):
                        ...
                        affected_nozzle.FuelPointChannel = Convert.ToInt32(response.Substring(27, 2));
                    ...
                    case((int)ResponseLengthEnum.LastSalesID):
                        ...
                        string LastSaleId = response.Substring(108, 6).Replace("-", "");
    ...
    {  
        ...
        public decimal DisplayPrice { set { displayPrice = value; } }
        public decimal DisplayLitres { set { displayLitres = value; } }
        public decimal DisplayEuroPerLitre { set { displayEuroPerLitre = value; } }
        public decimal TotalLitres { set { totalLitres = value; } }
