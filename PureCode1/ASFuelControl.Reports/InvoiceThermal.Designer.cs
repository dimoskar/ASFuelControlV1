namespace ASFuelControl.Reports
{
    ...
    "=neutral, PublicKeyToken=null";
            ...
            this.companyTINDataTextBox.Value = "Α.Φ.Μ.:{Fields.CompanyTIN}";
            // 
            ...
            this.companyTaxOfficeDataTextBox.Value = "Δ.Ο.Υ.:{Fields.CompanyTaxOffice}";
            // 
            ...
            this.companyPhoneDataTextBox.Value = "Τηλέφωνο : {Fields.CompanyPhone}";
            // 
            ...
            this.transactionDateDataTextBox.Value = "Ημερομηνία: {Fields.TransactionDate.ToString(\"dd/MM/yyyy\")}";
            // 
            // shape1
            // 
            ...
            this.textBox9.Value = "Σύνολο Ποσοτήτων :";
            // 
            // textBox10
            // 
