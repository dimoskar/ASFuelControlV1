    ...
    public class Box69IfsfConnector : IFuelProtocol, IPumpDebug
    {
        ...
        private void ThreadRun()
        {
            ...
            while (this.IsConnected)
            {
                ...
                {
                    Logging.Logger.Instance.LogToFile("TrheadRun", ex);
                    Thread.Sleep(100);
                }
            }
        }
            ...
            byte[] cmd = new byte[84]
      {
        ...
        private bool EvaluateDisplayData(Nozzle nozzle, byte[] buffer)
        {
            ...
            {
                Logging.Logger.Instance.LogToFile("evalDisplay " + BitConverter.ToString(buffer), ex);
                return false;
            }
        }
        ...
        private bool EvaluateTotals(Nozzle nz, byte[] buffer)
        {
            ...
            {
                Logging.Logger.Instance.LogToFile("Totals: " + BitConverter.ToString(buffer), ex);
                return false;
            }
        }
        ...
        private void EvaluateStatus(byte[] buffer, FuelPoint fp)
        {
            ...
            {
                Logging.Logger.Instance.LogToFile("Status " + BitConverter.ToString(buffer), ex);
            }
        }
                ...
                BitArray bitArray = new BitArray(new byte[1]
        {
          buffer[0]
            ...
            {
                Logging.Logger.Instance.LogToFile("evalActiveNz " + BitConverter.ToString(buffer), ex);
            }
        }
        ...
        private bool ExecuteCommnad(byte[] cmd, Box69IfsfConnector.ResponseLenght l, Box69IfsfConnector.CommandType c)
        {
            ...
            {
                Logging.Logger.Instance.LogToFile("executeCommand cmd= " + BitConverter.ToString(cmd), ex);
                return false;
            }
        }
