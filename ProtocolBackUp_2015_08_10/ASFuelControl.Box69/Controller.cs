...
namespace ASFuelControl.Box69
{
    public class Controller : Common.IController
    {
        ...
        public Controller()
        {
            ...
            controller.StatusChanged += new EventHandler<StatusChangedEventArgs>(fp_StatusChanged);
        }
        ...
        {
            this.AddFuelPoint(channel, address, nozzleCount, 2, 3,3);
        }
        ...
        void fp_TotalsRecieved(object sender, TotalsEventArgs e)
        {
            ...
            Common.FuelPoint fp = pair.Key;
            //fp.Address = fuelPoint.AddressId;
            //fp.Channel = fuelPoint.Channel;
            //fp.Status = fuelPoint.Status;
            ...
            if (this.TotalsRecieved != null && fp.Initialized==true)
            {
        ...
        void fp_DataChanged(object sender, EventArgs e)
        {
            ...
            if (fp.ActiveNozzle != null)
            {
                ...
                if (values.Status == Common.Enumerators.FuelPointStatusEnum.TransactionCompleted || values.Status == Common.Enumerators.FuelPointStatusEnum.TransactionStopped)
                {
                    ...
                    fuelPoint.ActiveNozzle.CurrentSale.TotalPrice = decimal.Round(fuelPoint.ActiveNozzle.CurrentSale.TotalVolume * fuelPoint.ActiveNozzle.CurrentSale.UnitPrice, fuelPoint.AmountDecimalPlaces);
                }
                else
                {
                    fuelPoint.ActiveNozzle.CurrentSale.TotalVolume = fp.LastSaleVolume;
                    fuelPoint.ActiveNozzle.CurrentSale.TotalPrice = decimal.Round(fp.LastSaleVolume * fuelPoint.ActiveNozzle.CurrentSale.UnitPrice, fuelPoint.AmountDecimalPlaces);
                }
        ...
        void fp_StatusChanged(object sender, StatusChangedEventArgs e)
        {
            ...
            {
                this.AuthorizeDispenser(fp.Channel, fp.Address);
            }
