...
namespace ASFuelControl.Reports
{
    public partial class ReportViewerForm : RadForm
    {
        ...
        {
            SelectFromToForm sftf = new SelectFromToForm();
            ...
            try
            {
                Data.DatabaseModel db = new Data.DatabaseModel(DBConnectionString);
        ...
        {
            SelectBalanceForm ssf = new SelectBalanceForm(this.DBConnectionString);
            DialogResult res = ssf.ShowDialog();
            if (res == DialogResult.Cancel)
                return;
            ...
            try
            {
                Data.DatabaseModel db = new Data.DatabaseModel(this.DBConnectionString);
