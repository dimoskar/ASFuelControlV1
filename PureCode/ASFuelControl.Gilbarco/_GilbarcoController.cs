...
{
    public class _GilbarcoController : Common.FuelPumpControllerBase
    {
        public _GilbarcoController()
        {
            this.Controller = new Connector();
        }

        public override void AddFuelPoint(int channel, int address, int nozzleCount, int decimalPlaces, int untiPriceDecimalPlaces)
        {
