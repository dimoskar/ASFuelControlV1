...
namespace ASFuelControl.Windows.UI.Forms
{
    public partial class DispenserInfoForm : RadForm
    {
        ...
        {
            if (Telerik.WinControls.RadMessageBox.Show("Βεβαιωθήτε ότι όλα τα ακροσωλήνια είναι κλειστά", "ΠΡΟΣΟΧΗ",  MessageBoxButtons.OKCancel, Telerik.WinControls.RadMessageIcon.Exclamation)  == System.Windows.Forms.DialogResult.Cancel)
                return;
