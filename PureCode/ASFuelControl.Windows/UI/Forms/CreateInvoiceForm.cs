...
namespace ASFuelControl.Windows.UI.Forms
{
    public partial class CreateInvoiceForm : RadForm
    {
        ...
        {
            decimal price = decimal.Round(this.volume1.Value * this.unitPrice1.Value, 2);
        ...
        private void radButton1_Click(object sender, EventArgs e)
        {
            ...
            newSale.TotalPrice = this.priceTotal1.Value;
            ...
            if (this.invoiceToReplace != null)
            {
                ...
                if (invoiceToReplace.FinancialTransactions.Count > 0)
                {
                    invoiceToReplace.FinancialTransactions[0].Amount = 0;
                }
            }
            ...
            if (item == null)
                ...
                invoice.PaymentType = item.Value;
