...
namespace Telerik.OpenAccess// ASFuelControl.Data
{
    ...
    {
        public static T CreateEntity<T>(this OpenAccessContext db)
        {
        ...
        public static T CreateEntity<T>(this OpenAccessContext db, List<NameValue> values)
        {
            T entity = (T)Activator.CreateInstance(typeof(T));
            try
            {
        ...
        public static void DeleteEntity(this OpenAccessContext db, object entity)
        {
