    ...
    public class TankWorkFlow : WorkFlow.IWorkFlow, ITankWorkFlow
    {
        ...
        private bool QueryFilling(object foo)
        {
            bool correntState = (this.Process.CurrentState == this.idleState || 
                ...
                this.Process.CurrentState == this.lowLevelState ||
                (this.Process.CurrentState == this.sallingState && this.Tank.IsLiterCheck) || (this.Process.CurrentState == this.errorState) || 
                this.Process.CurrentState == this.levelIncreaseState || this.Process.CurrentState == this.offlineState);
